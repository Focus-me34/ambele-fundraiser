...
const QuiSommesNous = () => {
  return (
    <div className={classes["content-container"]}>
      ...
      <p>
        Ambélé (on est ensemble) est une association montpelliéraine Loi 1901 de
        solidarité internationale par l’éducation populaire.
      </p>

      <p>
        Ambélé a pour objet de soutenir et accompagner des initiatives et des
        démarches d’éducation populaire d’habitants de l'Afrique subsaharienne
        de l'Ouest francophone. Son projet se déploie actuellement en République
        de Guinée à travers un appui logistique et un transfert de compétences,
        notamment par la mise en synergie de ressources humaines bénévoles
        françaises et guinéennes.
      </p>
      ...
      <p>
        L'éducation populaire qui puise ses racines dans la philosophie des
        Lumières, son ambition d'égalité et d'universalisme se déploie
        parallèlement, voire de manière complémentaire, aux systèmes d'éducation
        traditionnels et institutionnels, afin de permettre à chacun de choisir
        et de construire sa place dans la société.
      </p>
      ...
      <h3>Une éducation pour tous</h3>
      <p>
        Elle est éducative et populaire dans la mesure où elle vise l'accès aux
        savoirs et à la culture pour tous, particulièrement les plus fragiles.
      </p>
      ...
      <p>
        Raphaël Zajtmann, président fondateur de l'association travaille dans
        le domaine de l'animation sociale depuis près de 20 ans. Titulaire d'un
        Desjeps (Diplôme d'Etat supérieur de la jeunesse, de l'éducation
        populaire et du sport), il est actuellement chef de service dans le pôle
        Animation de la Vie Sociale de l'association Gammes (Montpellier). A ce
        titre, il supervise les actions d'un centre social et de deux EVS
        (espaces de vie sociale). Depuis 2015, il effectue de très réguliers
        séjours au Sénégal et en Guinée, notamment pour accompagner bénévolement
        des projets locaux d'éducation populaire.
      </p>
    </div>
