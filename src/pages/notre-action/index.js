  ...
  return (
    <div className={classes["content-container"]}>
      ...
      <p style={{ color: "blue" }}>
        ...
        secondaire du quartier par un accompagnement scolaire à distance via le
        support numérique.
      </p>
      <h3>Cette activité de cyber-accompagnement est au centre du projet.</h3>
      <p>
        Le projet s'appuie sur le constat de trois facteurs facilitants : la
        francophonie partagée, la proximité des systèmes et programmes scolaires
        entre les deux pays et la présence d'une couverture internet sur place.
      </p>
      <p style={{ color: "blue" }}>
        Le projet se construit en partenariat avec deux structures locales : un
        Lycée mixte public du quartier dit Lycée de jeunes filles et la
        Coguiféminine DD, ONG guinéenne dont le siège se situe dans le quartier
        (lien Quels acteurs ?).
      </p>
      <p>
        Le projet s'adresse à des élèves aux potentiels reconnus par leurs
        enseignants, dans des situations de difficultés sociales et/ou
        économiques avérées et adhérant, ainsi que leurs parents, au projet (sa
        démarche et son organisation).
      </p>
      <p>
        Le projet vise ainsi à compenser des insuffisances de ressources dans
        l'environnement de jeunes impactant leur développement de compétences
        scolaires, en mettant à leur disposition des temps de travail
        sécurisants et stimulants. Son résultat attendu est la consolidation du
        parcours scolaire des élèves concernés, voire la légitimation de sa
        poursuite auprès de leur entourage et une contribution ainsi à la lutte
        contre les phénomènes d'abandon contraint, en particulier pour les
        filles.
      </p>
      <p>
        En raison des inégalités de genre dans le maintien dans la scolarité,
        une attention particulière est portée sur l'inscription de jeunes filles
        dans le projet, avec une intégration prioritaire de ces dernières.
      </p>
      <p>
        En revanche, du fait de contraintes inhérentes au projet (usage du
        virtuel, nécessité d'une relative maîtrise de la langue française par
        les jeunes accompagnés), l'activité ne peut pas concerner des élèves aux
        difficultés cognitives ou méthodologiques importantes.
      </p>
      <p>
        Le projet consiste aussi, sur la base de cette activité de facilitation
        de l'accès à la connaissance pour un public fragilisé, à décliner deux
        autres notions fondamentales de l'éducation populaire : l'autonomisation
        et la participation de tous dans la prise de responsabilité et de
        décision.
      </p>
      {/* // ! ===================================== */}
      <h3>B) On est ensemble à Kobaya, comment ?</h3>
      ...
      <p>
        L'activité consiste en une aide technique permettant l'appropriation et
        la consolidation de savoirs, savoir faire et de procédés
        méthodologiques.
      </p>
      <p>
        Il ne s'agit pas de proposer un cours à part entière mais, à partir des
        notions travaillées en cours, d'expliciter des points mal compris, de
        renforcer des connaissances trop fragiles et faciliter l'acquisition de
        savoir faire ré-exploitables en matière de méthodologie.
      </p>
      <ul>
        Elle se décline:
        <li>
          en séances hebdomadaires d'1 heure voire 1 heure 1 /2 réunissant
          autour d'une matière spécifique un(e) bénévole français(e) et de 1 à 5
          élèves maximum de (dans une?) même classe,
        </li>
        <li>
          par l'intermédiaire d'une application de visiophonie permettant la
          communication instantanée par oral, écrit et la transmission de
      ...
      <p>
        Ils sont encouragés et facilités par la possibilité d'accéder au local
        avant les séances programmées, en présence du coordinateur bénévole qui
        accompagne les jeunes dans leur autonomisation, par la mise à
        disposition de sites internet autour de la langue française et par leur
        prise en main de l'outil informatique.
      </p>
      <p style={{ "font-size": "3rem", color: "red", "line-height": "2.5rem" }}>
      ...
      <p>
        A Conakry la population est majoritairement jeune, à l'image du pays où
        plus de 60% de la population a moins de 18 ans.
      </p>
      <p>
        La Guinée souffre globalement d'une pauvreté endémique (près de la
        moitié de la population vit en-dessous du seuil de pauvreté),
      ...
      <p>
        Désormais, la problématique, spécifiquement dans les zones urbaines
        comme Conakry, est moins celle de l'accès que celle du maintien dans la
        scolarité : le taux d'achèvement des écoles primaires se situe autour de
        54%, avec de fortes disparités entre les genres (46% pour les filles
        contre 64% pour les garçons) chiffres Unicef.
      </p>
      <p>
        En 2022, le taux de réussite du brevet serait de 25% et celui du
        baccalauréat de 30%.
      ...
      <p>
        Originairement peuplé de pécheurs et d'agriculteurs, un grand nombre de
        ses habitants tire encore de faibles revenus du secteur de la pêche
        (beaucoup moins de l'agriculture du fait de la montée des eaux salines
        et de l’appropriation des terrains pour l’extension de la capitale),
        d'autres, de l'économie informelle. Seule 10% de la population
        appartiendrait aux classes supérieures.
      ...
      <p>
        De ce fait, et en raison également de la construction de résidences
        secondaires par de nombreux émigrés originaires du quartier installés en
        occident, l'habitat est particulièrement disparate, alternant des zone
        d'habitats extrêmement rudimentaires (maisons exiguës de plain pied en
        béton et tôle, parfois sans eau ni électricité), immeubles et villas
        très confortables.
      </p>
      <p style={{ "font-size": "3rem", color: "red", "line-height": "2.5rem" }}>
      ...
      <p>
        ...
        les moins en difficulté inscrivent leurs enfants, afin d'échapper aux
        difficultés matérielles et, de ce fait, pédagogiques, des écoles
        publiques : manque d'équipement et de matériel pédagogiques et effectif
        pléthorique.
      </p>
      <p>
        Face aux freins cumulés dans le maintien dans la scolarité et en absence
        de soutien social ou éducatif alternatif, de nombreux jeunes mineurs du
        quartier abandonnent l'école pour de petits travaux journaliers très
        faiblement rémunérateurs ou, pour les jeunes filles, en raison de
        mariages précoces. D'autres rejoindraient la cohorte des postulants
        guinéens à l'émigration clandestine.
      </p>
      <p>
        De fait, la Guinée se situe régulièrement parmi les 4 premières nations
        (et au premier rang du continent africain) en matière de demandes
        d'asile en France.{" "}
      </p>
      <p>
        En 2021, le Lycée de Jeunes filles a effectué une recherche sur les
      ...
      <p>
        Les raisons les plus souvent invoquées par les élèves concernés ont été
        le mariage précoce, la manque de soutien des parents, la nécessité de
        contribuer économiquement au budget familial et les frais trop élevés du
        matériel de scolarité.
      </p>
      <p>
        L'équipe enseignante a mentionné également le facteur aggravant de la
        mauvaise maîtrise par les élèves de la langue française qui serait à
      ...
      <ul>
        ...
        <p>
          ...
          matérielle, rencontres d'acteurs locaux pour l'insertion du projet
          dans son environnement, animation de réunions d'informations auprès
          des élèves et des enseignants et de réunions de concertation (conseil
          de maison).
        </p>
        ...
        >
          Photo Lycée 1 Légende : Le Lycée de Jeunes filles de Kobaya (bâtiment
          de gauche)
        </p>
        ...
        <p>
          Il fait le lien avec l'équipe enseignante du Lycée pour identifier les
          élèves potentiels, suivre l’accompagnement des élèves concernés et
          évaluer son impact.
        </p>
        <p>
          Il est l'interlocuteur des parents des élèves repérés et accompagnés,
          auprès desquels il explicite le projet, son fonctionnement et ses
          objectifs afin de lever les freins éventuels à la participation de
          leurs enfants -notamment pour les jeunes filles, pour lesquelles les
        ...
        <p>
          Il est responsable du suivi administratif de l'action en lien avec le
          bénévole de l'association Ambélé avec lequel il est en communication
          quasi quotidienne.
        </p>
        ...
        <p>
          Cette association sans but lucratif, non confessionnelle et apolitique
          a pour mission de promouvoir et renforcer la place des femmes dans la
          gestion du secteur minier, des ressources naturelles et, d'une manière
          générale, dans la société guinéenne.
        </p>
        <p>
          Parmi les leviers retenus, figurent « la promotion de l'éducation à
          travers la formation des enfants, des jeunes filles et garçons » ainsi
          que « la promotion démocratique et citoyenne ».
        </p>
        <p>C'est dans ce cadre que s'inscrit le partenariat avec cette ONG. </p>
        <p>
          La Coguiféminine DD assume la responsabilité de l'activité sur site.
        </p>
        <p>
        ...
        <p
          style={{ "font-size": "3rem", color: "red", "line-height": "2.5rem" }}
        >
          Photo maison des jeunes de Kobaya Légende : L'entrée de la Maison des
          jeunes de Kobaya
        </p>
        ...
        <p style={{ "font-weight": "bold" }}>
          Les rôles respectifs de chacun de ces acteurs ainsi que les modalités
          de leur coordination ont été formalisés par une convention tripartite.
        </p>
      </ul>
      {/* // ! ===================================== */}
      <h3>E) Quels résultats ?</h3>
      ...
      <p>
        Il s'agit, à ce jour, du français, des mathématiques, de la physique, de
        la chimie, de la biologie et de l'anglais.
      </p>
      <hr />
      <hr />
      <hr /> DUBLE CHECK HERE (architecture design)
      <h3>Un cyber accompagnement sous quelles formes ?</h3>
      <p>
        Différents types d’activités pédagogiques sont mis en place en fonction
        des besoins identifiés, des expériences et affinités des bénévoles, en
        lien avec le coordinateur sur site : reprise, à la demande des élèves,
        de notions vues en cours (explicitation, entraînement), travail en
        commun sur des exercices d’entraînement –devoirs transmis par les
        enseignants ou exercices proposés par le/la bénévole sur des thématiques
        abordées en cours, séance de conversation en anglais, réalisation de
        fiches synthétisant les informations principales abordées pendant la
        séance et transmises aux élèves concernés...
      </p>
      <p
        style={{
          "font-size": "3rem",
      ...
      >
        -Vidéo français 2 Légende : Matière: français, classe de 9ème
        (équivalent de 4ème française) Correction d'exercices d'écriture
        transmis par la bénévole avant la séance sur des notions travaillées en
        cours (la description et le récit).
      </p>
      <p
        style={{
          "font-size": "3rem",
      ...
      >
        -Vidéo Math 2 (2 garçons) Matière : mathématiques, classe de 12ème
        (équivalent 1ère française) Explicitation d'une notion travaillée depuis
        peu en cours : résolution d’une inéquation
      </p>
      <p
        style={{
          "font-size": "3rem",
      ...
      >
        ...
        9ème (équivalent de 4ème française) Correction d’exercices
        d’entraînement effectués avant la séance (lexique de l’espace/du lieu
        puis des sensations), dans le cadre d’un travail régulier sur des fiches
        d’enrichissement du vocabulaire transmises par la bénévole.
      </p>
      <p
        style={{
          "font-size": "3rem",
